...
fun MultipartFormListItem(
    ...
    OutlinedCard(
        ...
        Row(Modifier.fillMaxWidth().padding(start = 15.dp, top = 15.dp), verticalAlignment = Alignment.CenterVertically){
            ...
            IconButton(onClick = { deleteItem() }, enabled = deleteButtonEnabled(), modifier = Modifier.padding(horizontal = 15.dp)) {
                ...
                OutlinedCard(
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        IconButton(modifier = Modifier, onClick = { onTextChanged(
                            MultipartFormState.File(Uri.EMPTY), true) }, enabled = multipartFormState.uri != Uri.EMPTY) {
                            Icon(imageVector = Icons.Outlined.Delete, contentDescription = "")
                        }
                    }
